 ...
 */
class LinkItem extends Component<Props> {

    /**
     * Initializes a new {@code LinkItem} instance.
     *
     * @inheritdoc
     */
    ...
    render() {
        ...
        return (
            <TouchableOpacity
                ...
                <View style = { styles.linkItemButtonContainer }>
                    <Icon
                        src = { this.props.icon }
...
export default translate(LinkItem);
